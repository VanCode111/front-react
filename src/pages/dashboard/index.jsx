        ...
        <div className={classes.secondaryItems}>
            <div className={classes.itemsContainer}>
                <Card classNames={[classes.card]}>
                    ...
                    <HorizontalProgressBar className={classes.progressBar} color="#AB5DE9" label="М" maxValue={3000} curValue={2567} />
                    <HorizontalProgressBar className={classes.progressBar} color="#F8D564" label="Ж" maxValue={3000} curValue={2076} />
                </Card>
                <Card classNames={[classes.card]}>
                    <h3 className={classes.title}>
                        Возраст аудитории:
